...
import type {OmitIndexSignature} from 'type-fest/source/omit-index-signature';
import type {PickIndexSignature} from 'type-fest/source/pick-index-signature';
...
import type {NonEmptyTuple} from 'type-fest/source/non-empty-tuple';
import type {ArrayTail} from 'type-fest/source/array-tail';
import type {UnknownRecord} from 'type-fest/source/unknown-record';

...
function createServerComponentsMiddleware(projectRoot, { rscPath , instanceMetroOptions , ssrLoadModule , ssrLoadModuleArtifacts , useClientRouter , createModuleId  }) {
    ...
    async function getExpoRouterClientReferencesAsync({ platform , domRoot  }, files) {
        ...
        const reactServerReferences = (ref = contents.artifacts.filter((a)=>a.type === "js")[0].metadata.reactServerReferences) == null ? void 0 : ref.map((ref)=>fileURLToFilePath(ref));
        ...
        const reactClientReferences = (ref1 = contents.artifacts.filter((a)=>a.type === "js")[0].metadata.reactClientReferences) == null ? void 0 : ref1.map((ref)=>fileURLToFilePath(ref));
        if (!reactClientReferences) {
